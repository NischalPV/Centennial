...
export class ProductsComponent implements OnInit {
  ...
  constructor(private service: ProductsService, private materialService: MaterialsService, private configurationService: ConfigurationService, private formBuilder: FormBuilder) { }
