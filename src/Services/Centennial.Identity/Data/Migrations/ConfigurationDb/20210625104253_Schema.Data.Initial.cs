...
{
    public partial class SchemaDataInitial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, null, new DateTime(2021, 3, 8, 11, 7, 29, 917, DateTimeKind.Utc).AddTicks(7870), null, "API Service", true, null, "API", false, true, null });

            migrationBuilder.InsertData(
                table: "ApiScopes",
                columns: new[] { "Id", "Description", "DisplayName", "Emphasize", "Enabled", "Name", "Required", "ShowInDiscoveryDocument" },
                values: new object[] { 1, null, "API Scope", false, true, "API", false, true });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 2592000, 3600, 0, true, false, false, true, null, false, false, 300, true, null, "client_", "centennial-angular", "Centennial Angular Frontend OpenId Client", "https://localhost:6003", null, new DateTime(2021, 6, 25, 11, 7, 29, 917, DateTimeKind.Utc).AddTicks(7870), null, 300, true, true, true, null, 300, true, null, null, false, null, "oidc", 1, 1, true, false, true, false, 1296000, false, null, null, null },
                    { 2, 2592000, 3600, 0, true, false, false, true, null, false, false, 300, true, null, "client_", "centennial-api", "Centennail API Swagger UI", null, null, new DateTime(2021, 6, 25, 11, 7, 29, 917, DateTimeKind.Utc).AddTicks(7870), null, 300, true, true, true, null, 300, true, null, null, false, null, "oidc", 1, 1, true, false, true, false, 1296000, false, null, null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2021, 6, 25, 0, 0, 0, 0, DateTimeKind.Utc), "Your user profile information (first name, last name, etc.)", "User profile", true, true, "profile", false, false, true, null },
                    { 2, new DateTime(2021, 3, 25, 0, 0, 0, 0, DateTimeKind.Utc), null, "Your user identifier", false, true, "openid", false, true, true, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, "https://localhost:6003" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "https://localhost:6003/" },
                    { 2, 2, "https://localhost:6002/swagger/" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                {
                    { 1, 1, "https://localhost:6003/" },
                    { 2, 2, "https://localhost:6002/swagger/oauth2-redirect.html" }
                });
