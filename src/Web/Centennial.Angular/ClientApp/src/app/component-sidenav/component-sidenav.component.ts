...
export class ComponentSidenav implements OnInit, OnDestroy {
  ...
  constructor(public menuItems: MenuItems, private _route: ActivatedRoute, private _navigationFocusService: NavigationFocusService, zone: NgZone, breakpoints: BreakpointObserver) {
